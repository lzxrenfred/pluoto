...
export default function AuthCallbackPage() {
  ...
  return <main className="auth-callback-shell"><section><strong className="auth-wordmark">pluoto</strong>{error ? <><p className="eyebrow">LINK UNAVAILABLE</p><h1>We couldn’t confirm that email.</h1><div className="form-error" role="alert">{error}</div><a className="primary wide" href="/">Return to sign in</a></> : <><div className="auth-spinner"/><h1>Confirming your account…</h1><p>Your Plane and invitation are still here.</p></>}</section></main>;
}
