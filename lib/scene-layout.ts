...
export const placements:Record<Person["scene"],Placement[]>={
  ren:[{kind:"path",tileX:1,tileY:2},{kind:"path",tileX:1,tileY:3},{kind:"path",tileX:1,tileY:4},{kind:"tree",tileX:4,tileY:0,variant:"tall"},{kind:"tree",tileX:3,tileY:1},{kind:"tree",tileX:0,tileY:3},{kind:"bush",tileX:2,tileY:0},{kind:"bush",tileX:4,tileY:2},{kind:"bush",tileX:3,tileY:4},{kind:"flowers",tileX:0,tileY:2},{kind:"flowers",tileX:2,tileY:4},{kind:"flowers",tileX:4,tileY:4},{kind:"mailbox",tileX:2,tileY:2},{kind:"bench",tileX:4,tileY:3}],
  ...
  wei:[{kind:"tree",tileX:4,tileY:0,variant:"tall"},{kind:"tree",tileX:0,tileY:4},{kind:"lamp",tileX:4,tileY:3},{kind:"bench",tileX:2,tileY:4},{kind:"bush",tileX:0,tileY:1},{kind:"flowers",tileX:4,tileY:1}],
