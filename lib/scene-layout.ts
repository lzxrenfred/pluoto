...
export const LAND_SIGN_CELL={tileX:4,tileY:4} as const;
export const placements:Record<Person["scene"],Placement[]>={
  ...
  maya:[{kind:"tree",tileX:1,tileY:1,variant:"blossom"},{kind:"table",tileX:2,tileY:3},{kind:"bench",tileX:3,tileY:3},{kind:"flowers",tileX:0,tileY:4},{kind:"flowers",tileX:4,tileY:0}],
